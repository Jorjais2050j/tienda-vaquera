...
(() => {
  ...
  const stylesheet =
    ...
    // pan-y (not none): images must never eat the vertical swipe that
    // scrolls the page on touch devices. Reframe-drag lives on .spill,
    // a separate element, so this doesn't affect that gesture.
